...
{
    TokenizerT* tok = (TokenizerT*) malloc(sizeof(TokenizerT)); // allocating memory for token 
...
int isFloat(char* returned, char* stream, int i, int j, TokenizerT * tk)
{
 ...
 /*
  * isFloat2: checks if the next token in TKGetNextToken is a Float (beginning as decimal, with a dot included).
  */
...
int isFloat2(char* returned, char* stream, int i, int j, TokenizerT * tk)
{
 ...
 /*
  * isFloat3: checks if the next token in TKGetNextToken is a Float (beginning as decimal, with NO dot included).
  */
